  ...
  return (
    <div className="">
      <div className="absolute z-[-1]">
        <img src="https://i0.wp.com/dmtalkies.com/wp-content/uploads/2021/03/ezgif-2-5452f5694b1f-compressed.jpg"
      ...
      <div className="p-10">
        ...
        <p className=" mt-5 hover:font-bold  transition-all duration-300">
          <span className="bg-purple-500 hover:scale-105
         text-white p-2 px-10 rounded-full 
         cursor-pointer">Play</span></p>

      </div>
      <div className="mt-10">
      <p className=" px-5 text-white text-[20px] font-bold">New Releases</p>

      <div className="w-full absolute bg-gradient-to-t
       from-gray-900  px-5 overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide">
        {videoList.map((item) => (
